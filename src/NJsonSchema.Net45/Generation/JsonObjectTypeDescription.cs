...
namespace NJsonSchema.Generation
{
    ...
    public class JsonObjectTypeDescription
    {
        ...
        public static JsonObjectTypeDescription FromType(Type type, IEnumerable<Attribute> parentAttributes, EnumHandling defaultEnumHandling)
        {
            ...
            var jsonSchemaAttribute = type.GetTypeInfo().GetCustomAttribute<NJsonSchema.Annotations.JsonSchemaAttribute>() ??
                parentAttributes?.OfType<NJsonSchema.Annotations.JsonSchemaAttribute>().SingleOrDefault();
